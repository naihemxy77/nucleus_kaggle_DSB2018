...
def model_gen(InputDim):
    ...
    local1_o = Lambda(lambda x: x[:,2:250,2:250,:],output_shape=(248,248,16))(local1)
    local2_o = Lambda(lambda x: x[:,1:249,1:249,:],output_shape=(248,248,16))(local2)
    #local3_o = Lambda(lambda x: x[:,:,:,:],output_shape=(248,248,16))(local3)
    mid1 = concatenate([local1_o,local2_o,local3])
    #global scan
    global1 = cnn_block(mid1, 32, 31, 'global1')
    global1 = Dropout(0.2)(global1)
    global2 = cnn_block(global1, 32, 31, 'global2')
    global2 = Dropout(0.2)(global2)
    global3 = cnn_block(global2, 32, 31, 'global3')
    global3 = Dropout(0.2)(global3)
    global4 = cnn_block(global3, 64, 31, 'global4')
