...
id_num = 'Candy_0314_Unet_rd_bright'
r = 0.2
SEED = 932894
...
#train_df = train_df[train_df['hsv_cluster']==2]
#total_ids = list(train_df.loc[train_df['hsv_cluster']==2,'ImageId'].values)
...
pickle.dump(Test_Label,open( "Test_Label_bright.p","wb" ))